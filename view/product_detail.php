                            ...
                            <div class="product-content">
                                ...
                                <form action="index.php?act=addcart" method="post">
                                    ...
                                    <div class="action">
                                        ...
                                        <input class="clickmua btn btn-primary" type="submit" name="addtocart" value="Thêm vào giỏ hàng">
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="sidebar-widget category">
                        ...
                        <ul class="list-group">
                            <?php foreach ($listdm as $dm) { ?>
                                <li class="list-group-item"><a href="index.php?act=sanpham&iddm=<?php echo $dm['id']?>"><?php echo $dm['name_dm']?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-23">
                        ...
                        <ul class="list-group">
                            <?php foreach ($sptop10 as $sp) { ?>
                                <li class="list-group-item"><a href="index.php?act=sanphamct&idsp=<?php echo $sp['id']?>"><?php echo $sp['tensp']?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
